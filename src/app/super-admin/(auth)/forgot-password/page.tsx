...
import ForgotPassword from '@/src/components/forms/user-forgot-password'
import { Metadata } from 'next'
import Image from 'next/image'
import Link from 'next/link'

export const metadata: Metadata = {
  title: 'Biloniya - Forgot Password',
  description: 'forgot your password by entering your email address.',
}
