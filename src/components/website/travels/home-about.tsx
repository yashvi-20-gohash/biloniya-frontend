...
const WelcomeSection: React.FC = () => {
  return (
    <div className="relative bg-white lg:py-12 py-8 pb-9 lg:pb-12">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h5 className="text-3xl font-semibold mb-3">
                <span className="flex items-center text-lg gap-4 font-secound text-[#b0191e]">
              ...
              <h2 className="lg:text-4xl text-2xl font-bold !leading-snug	">Explore Your Next
                Great Adventure with Travel Ease</h2>
            </div>

            <div className="space-y-6 lg:!mt-3">
              <span className="font-normal leading-7"> {`At Biloniya Group, we understand the importance of a great Travel, whether for business or leisure. Our Travel offer top-notch services to make your visit memorable, safe, and stress-free. Here's what we provide:`} </span>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">

                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Daily Travel</span>
                </div>

                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Adventure Trips Travel</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Family Travel </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Luxury Car Travel</span>
                </div>

                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Party Travel</span>
                </div>

                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-medium"> Office Travel </span>
                </div>
            ...
            <div className="flex items-center justify-between">
              <a href="/about" className="inline-block px-8 py-2.5 bg-[#b0191e] text-white rounded font-semibold hover:bg-black transition-colors">
                Explore Now
              </a>
            </div>
          </div>
          ...
          <div className="relative">
            <Image src="/travels/security-img.png" alt="About Us" className="w-full rounded-lg" width={1500} height={1500} />
          </div>
        </div>
      </div>
      <div className="absolute top-[51%] rounded-lg">

        <Image src="/home/section-vector1.png" alt="About Us" className="w-44 rounded-lg" width={1000}
          height={1000} />
      </div>
    </div>
  );
