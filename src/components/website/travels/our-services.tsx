        ...
        <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-6 gap-12">
          {hotelData.map((hotel) => (
            <div key={hotel.id} className="w-full group cursor-pointer">
              <div className="bg-white lg:min-h-[360px] rounded-xl shadow-[0_2px_8px_0px_rgba(0,0,0,0.2)] overflow-hidden transition-all duration-300 hover:shadow-lg">
                {/* Image Section */}
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt={hotel.title}
                    fill
                    className="object-cover transition-transform duration-300 group-hover:scale-105 object-bottom"
