  ...
  const slides = [
    {
      ...
      description: "Curabitur convallis enim at orci ullamcorper sagittis. Morbi porand gon nullalacu scelerisque in aliquam vitae, aliquam ut lectus. Nam utte mink Phasellus magna, efficitur finibus dictum auctor, volutpat gonet torrend accumsan purusDon luctus nunc non dapibus volutpat.",
      features: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {slides[currentSlide].features.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2">
                      ...
                      <span className="text-sm sm:text-[15px] font-semibold">{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="relative flex items-center">
            ...
            <div className="absolute inset-0 flex justify-center items-center">
              <div className="w-20 sm:w-28 h-20 sm:h-28 bg-white flex justify-center items-center rounded-full p-4">
                <Image
                  src="/home/tripadvisor-logo2.svg"
                  alt="Facility"
                  className="object-cover w-12 sm:w-14"
                  width={1000}
                  height={1000}
                />
              </div>
