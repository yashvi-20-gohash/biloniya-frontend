...
const tourData = [
  {
    ...
    duration: "1 Week",
    location: "jaipur",
    title: "Discover Bouncers Security",
    perograp: " Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type ",
    price: 340,
    originalPrice: 450,
    imageUrl: "/security/security-3.jpg",
    locationLink: "egypt"
  },
  {
    id: 2,
    duration: "1 Week",
    location: "jaipur",
    title: "Discover Party Security",
    perograp: " Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type ",
    price: 340,
    originalPrice: 450,
    imageUrl: "/security/security-5.jpg",
    locationLink: "egypt"
  },
  {
    id: 3,
    duration: "1 Week",
    location: "jaipur",
    title: "Discover  Celebrity Security",
    perograp: " Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type ",
    price: 340,
    originalPrice: 450,
    imageUrl: "/security/security-1.jpg",
    locationLink: "egypt"
  },
  {
    id: 4,
    duration: "1 Week",
    location: "jaipur",
    title: "Discover Meetup Security",
    perograp: " Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type ",
    price: 140,
    originalPrice: 250,
    imageUrl: "/security/security-4.jpg",
    locationLink: "egypt"
  },
...
const OurServices = () => {
  return (
    <section id="service" className="lg:pt-16 lg:pb-20 pt-12 pb-16 bg-gray-100">
      <div className="px-4 max-w-screen-xl mx-auto">
        ...
        <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-6 gap-12">
          {tourData.map(tour => (
            <div key={tour.id} className="w-full group cursor-pointer ">
              <div className="bg-white lg:min-h-[408px] rounded-xl shadow-[0_2px_8px_0px_rgba(0,0,0,0.2)] overflow-hidden transition-all duration-300 hover:shadow-lg">
                {/* Image Section */}
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold text-gray-800 mb-2 hover:text-[#b0191e] transition-colors">
                    {tour.title}
                  </h3>

                  <div className='mb-3'>
                    <p className="text-gray-600 hover:text-[#b0191e] text-sm transition-colors">
                      {tour.perograp}
                    </p>
                  </div>
