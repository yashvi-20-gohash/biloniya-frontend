        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h2 className="lg:text-4xl text-2xl font-bold !leading-snug	">Security & Safety from Biloniya Group of Companies</h2>
            </div>

            <div className="space-y-6 lg:!mt-5">
              <span className="font-normal leading-7">Your security is our top priority at Biloniya Group of Companies. We implement comprehensive measures to protect your Security and ensure safe travels:</span>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold">Bouncers Security</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Party Security</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold">Wadding Security</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold">Travel Security</span>
                </div>
          ...
          <div className="relative">
            <Image src="/security/security-img.png" alt="About Us" className="w-full rounded-lg" width={1500} height={1500} />
          </div>
        </div>
      </div>
