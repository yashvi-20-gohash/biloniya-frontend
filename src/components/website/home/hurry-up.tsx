    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        <div className="flex items-center justify-center font-secound gap-3 mb-3">
          ...
          <span className="text-[#b0191e] text-base"> Hurry Up </span>
          <span className="text-xl">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="#b0191e">
              <path
                fill-rule="evenodd"
        ...
        <h2 className="text-4xl font-bold"> Phenomenal Deals Offered
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-3 relative overflow-hidden rounded-lg">
          <div className="relative h-[500px]">
            ...
            <div
              className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-[#b0191e]/90 to-[#b0191e]/0 rounded-b-lg bg-cover bg-no-repeat"
              style={{ backgroundImage: "url('/home/banner2.svg')" }}
            >
              <p className="text-white text-center italic mb-2">Savings worldwide</p>
              <h3 className="text-5xl font-bold text-center text-white mb-3">20% Off</h3>
              <button className="text-white hover:underline flex mx-auto">Discover Great Deal</button>
            </div>
        ...
        <div className="md:col-span-5 flex flex-col gap-6">
          <div className="relative h-[238px]">
            ...
            <div
              className="absolute bottom-0 left-0 right-0 p-8 pb-1 bg-gradient-to-t from-[#b0191e]/90 to-[#b0191e]/0 rounded-b-lg bg-cover bg-no-repeat"
              style={{ backgroundImage: "url('/home/banner3.svg')" }}
            >
              <div>
                <div>
                  <p className="text-white italic">Couple Tour</p>
                  <h3 className="text-xl font-bold text-white mb-3">4 Days In Switzerlandss</h3>
                </div>
                <div className="absolute bottom-2 right-6 bg-[#b0191e] text-white rounded-full p-2">
                  <p className="text-center p-0 leading-3">
                    <span className="text-lg font-bold block m-0 p-0">50%</span>Off
                  </p>
                </div>
          ...
          <div className="relative h-[238px]">
            ...
            <div
              className="absolute top-0 h-full left-0 right-0 p-8 bg-gradient-to-t from-[#b0191e]/90 to-[#b0191e]/0 rounded-b-lg bg-cover bg-no-repeat"
              style={{ backgroundImage: "url('/home/banner4.svg')" }}
            >
              <div className='flex h-full items-center'>
                <div>
                  <p className="text-white italic mb-1"> Honeymoon Tour </p>
                  <h3 className="text-xl font-bold text-white mb-2"> Enjoy <span> 40% </span> Off </h3>
                  <p className='text-sm mb-4 text-white'>
                    2 Country & 15 Location
                  </p>

                  <button className='bg-[#b0191e] text-sm font-semibold text-white px-4 py-1.5 rounded'>
                    Book Now
                  </button>
        ...
        {/* Right Card */}
        <div className="md:col-span-4 relative overflow-hidden rounded-2xl">
          <div className="relative h-[500px]">
            <Image
              src="/home/harry-up-card-3.png"
              alt="Traveler with backpack"
              className="w-full h-full object-cover rounded-lg"
              width={1000}
              height={1000}
            ...
            <div
              className="absolute top-0 left-0 right-0 p-5 px-8 bg-gradient-to-t from-[#b0191e]/90 to-[#b0191e]/0 bg-cover bg-bottom bg-no-repeat"
              style={{ backgroundImage: "url('/home/banner5.svg')" }}
            >
              <div className='flex justify-between items-center pb-8'>
                <div>
                  <p className="text-white  italic mb-1">Savings worldwide</p>
                  <h3 className="text-2xl font-bold  text-white">20% Off</h3>
                  <p className="text-white text-xs mb-1"> For Your First Book</p>
                </div>
