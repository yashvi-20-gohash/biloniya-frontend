...
const WelcomeSection: React.FC = () => {
  ...
  const tabs: Record<TabKey, Tab> = {
    mission: {
      ...
      content:
        'Etiam ac tortor id purus commodo vulputate. Vestibulum porttitor erat felis and sed vehicula tortor malesuada gravida. Mauris volutpat enim quis pulv gont congue. Suspendisse ullamcorper, enim vitae tristique blandit, eratot augue torel tempo libero, non porta lectus tortor et elit.',
    },
    customer: {
      title: 'Focus On Customer',
      icon: <Users className="w-8 h-8" />,
      content:
        'Gtiam ac rortor id jkugs commodo vulputate. Vebsidoe porttitor erat felis and sed vehicula tortor malesuada gravida. Mauris volutpat enim quis pulv gont congue. Suspendisse ullamcorper, enim vitae tristique blandit, eratot augue torel tempo libero.',
    },
  };

  return (
    <div className="relative bg-white lg:py-16 py-24 pb-8 lg:pb-10">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h2 className="lg:text-4xl text-2xl font-bold">
                {`  Let's know About Our Journey For TripRex`}
              </h2>
            </div>
              ...
              <div className="flex gap-4">
                {Object.entries(tabs).map(([key, { title, icon }]) => (
                  <button
                    ...
                    className={`flex items-center lg:gap-5 gap-2 py-2 lg:text-base text-sm rounded-lg transition-all lg:mr-4 ${activeTab === key
                      ? 'text-[#b0191e]'
                      : ' text-gray-600'
                      }`}
                  >
            ...
            <div className="flex items-center justify-between">
              <a
                href="/about-us"
                className="inline-block px-8 py-3 bg-[#b0191e] text-white rounded font-semibold hover:bg-black transition-colors"
              >
                More About
              </a>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-bold text-lg text-black leading-4">
                    600+
                  </div>
      ...
      <div className="absolute top-[51%] rounded-lg">   <Image
        src="/home/section-vector1.png"
        alt="About Us"
