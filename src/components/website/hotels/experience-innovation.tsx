  ...
  const slides = [
    {
      ...
      description: "Enjoy the perfect blend of comfort and elegance at our luxurious hotel. From cozy rooms to world-class amenities, we ensure an unforgettable stay.",
      features: [
