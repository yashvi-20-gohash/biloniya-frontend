...
const WelcomeSection: React.FC = () => {
  return (
    <div className="relative bg-white lg:py-6 py-8 pb-9 lg:pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <h2 className="lg:text-4xl text-2xl font-bold !leading-snug	">Your Comfort, Our Priority at Biloniya Group of Companies</h2>
            </div>

            <div className="space-y-6 lg:!mt-5">
              <span className="font-normal leading-7"> {`At Biloniya Group, we understand the importance of a great stay, whether for business or leisure. Our hotels offer top-notch services to make your visit memorable, safe, and stress-free. Here's what we provide:`} </span>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Luxury Stays</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Party Venues</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Wedding Services </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Office Meetings & Conferences </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-3 h-3 bg-[#b0191e] rounded-full"></div>
                  <span className="text-sm sm:text-base font-semibold"> Travel Packages </span>
                </div>
          ...
          <div className="relative">
            <Image src="/hotels/security-img.png" alt="About Us" className="w-full rounded-lg" width={1500} height={1500} />
          </div>
        </div>
      </div>
