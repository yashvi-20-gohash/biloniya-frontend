...
interface DataTableRowActionsProps<TData extends TestimonialLisType> {
  row: CustomRow<TData>
}

export function DataTableRowActions<TData extends TestimonialLisType>({
  row,
  ...
  const handleConfirmDelete = async () => {
    const resp = await deleteTestimonial(id)
  ...
  const handleEdit = async () => {
    await getTestimonialDetails(id)
    setEditModel(true)
  }
  ...
  const handleUpdateState = async () => {
    ...
    const resp = await updateTestimonialStatus(data)
    console.log("resp", resp);

    if (resp?.status === 'SUCCESS') {
      const data = { ...row.original, ...resp?.data?.lastData as TestimonialLisType }
  ...
  return (
    <>
      ...
      <AlertModal
        ...
        loading={isDeleteTestimonialLoading}
        variant={'default'}
        title={'Delete Blog'}
      ...
      <AlertModal
        ...
        loading={isTestimonialStatusLoading}
        variant="default"
        title={'Update Status'}
