import GithubIcon from "@/src/components/front/icons/github-icon";
import LinkedInIcon from "@/src/components/front/icons/linkedin-icon";
import XIcon from "@/src/components/front/icons/x-icon";
import {
  Card,
  CardContent,
  CardHeader,
    ...
    <section id="team" className="container lg:w-[75%] py-24 sm:py-32">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {teamList.map(({ imageUrl, firstName, lastName, positions, socialNetworks }, index) => (
          <Card
            key={index}
            className="bg-muted/60  flex flex-col h-full overflow-hidden group/hoverimg"
          >
